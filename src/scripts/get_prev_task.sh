...
PREVIOUS_TASK_DEFINITION="$(aws ecs describe-task-definition --task-definition "${ECS_TASK_DEFINITION_NAME}" --include TAGS --region "${ORB_STR_REGION}" --profile "${ORB_STR_PROFILE_NAME}" "$@")"
